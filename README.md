...
* [`no-sleep.ts`](pi-extensions/no-sleep.ts) - Intercepts bash tool calls and blocks any that invoke `sleep`, preventing agents from blocking the session with polling/wait loops.
