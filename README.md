...
* [`forget`](pi-extensions/forget) - Safe context cleanup workflow that uses a transient sanitizer session to build a cleaned successor branch with `/forget <query>`; it does not rewrite session files in place and keeps the old branch intact.
