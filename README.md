...
* [`pi-subagents`](pi-extensions/pi-subagents) - Claude Code-style autonomous subagents with background runs, custom agent types, steering, resume, and cross-extension RPC (`subagents:rpc:*`).
