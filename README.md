...
* [`forget`](pi-extensions/forget) - Compaction-shaped context cleanup workflow for `/forget <query>` that runs an extension-local copied compaction core with cleanup/removal prompts.
