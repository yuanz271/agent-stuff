...
- `session-breakdown` → `https://github.com/mitsuhiko/agent-stuff` @ `ab79f98104bcd3c6a7c5491e609f6d6700a7414d` (`origin/main`) [upstream `extensions/session-breakdown.ts`]
