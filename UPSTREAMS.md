...
- `files` → `https://github.com/mitsuhiko/agent-stuff` @ `521cafdb9ed3923e8ace90c5af9d2c7d92c10f86` (`origin/main`) [upstream `extensions/files.ts`]
- `control` → `https://github.com/mitsuhiko/agent-stuff` @ `521cafdb9ed3923e8ace90c5af9d2c7d92c10f86` (`origin/main`) [upstream `extensions/control.ts`]
- `loop` → `https://github.com/mitsuhiko/agent-stuff` @ `521cafdb9ed3923e8ace90c5af9d2c7d92c10f86` (`origin/main`) [upstream `extensions/loop.ts`]
...
- `pi-schedule-prompt` → `https://github.com/tintinweb/pi-schedule-prompt` @ `ef7ab49f2988fa58412eb3e050faefde3b9aedb6` (`origin/master`)
