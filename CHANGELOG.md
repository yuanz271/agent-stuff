...
* Added `plan-build` as a tmux-backed persistent builder-session controller for planner→builder workflows, replacing the earlier read-only planning sandbox.
